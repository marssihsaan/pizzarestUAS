...
public class MainActivity3 extends AppCompatActivity {
    TextView pizzadesc, spagetidesc, burgerdesc, steakdesc;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spagetidesc = findViewById(R.id.spagetidesc);
        burgerdesc = findViewById(R.id.burgerdesc);
        steakdesc = findViewById(R.id.steakdesc);
    ...
    private void munculData() {
        loading = ProgressDialog.show(MainActivity3.this, "Data Dimuat", "Tunggu Sejenak...");
        ...
        StringRequest stringRequest = new StringRequest(
            ...
            public void onErrorResponse(VolleyError error) {
                loading.cancel();
                Toast.makeText(MainActivity3.this, "Invallid API" + error, Toast.LENGTH_SHORT).show();
            }
        }
        );
